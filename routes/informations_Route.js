...
router
  ...
  .post("/", upload.single("thumbnail"), async function (req, res) {
    const information = new Information({
      ...
      arrive_time_abroad: req.body.abroad_country,
      ...
      submit_person_name: req.body.submit_person_ticket,
      ...
      submit_person1_name: req.body.submit_person1_ticket,
      ...
      headmaster_position: req.body.headmaster_position,
      headmaster_dept: req.body.headmaster_dept,
      headmaster_dept_date: req.body.Date, */
    });
    try {
